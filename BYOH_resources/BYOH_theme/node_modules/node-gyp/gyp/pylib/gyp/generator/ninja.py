        ...
        if sources:
            ...
            if obj_outputs:
                if self.flavor != "mac" or len(self.archs) == 1:
                    ...
                    print "Warning: Actions/rules writing object files don't work with " "multiarch targets, dropping. (target %s)" % spec[
                        "target_name"
                    ]
...
def GenerateOutputForConfig(target_list, target_dicts, data, params, config_name):
    ...
    for qualified_target in target_list:
        ...
        assert (
            make_global_settings == this_make_global_settings
