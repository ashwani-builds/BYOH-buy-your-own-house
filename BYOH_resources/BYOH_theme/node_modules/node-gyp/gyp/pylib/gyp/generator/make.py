...
"""
    ...
    def WriteActions(
        ...
        for action in actions:
            ...
            self.WriteDoCmd(
                outputs,
                map(Sourceify, map(self.Absolutify, inputs)),
    ...
    def WriteRules(
        ...
        for rule in rules:
            ...
            for rule_source in rule.get("rule_sources", []):
                ...
                inputs = map(
                    Sourceify,
                    map(self.Absolutify, [rule_source] + rule.get("inputs", [])),
                )
...
# See "Target-specific Variable Values" in the GNU Make manual."""
    ...
    def WriteAndroidNdkModuleRule(self, module_name, all_sources, link_deps):
        ...
        self.WriteList(
            map(self.Absolutify, filter(Compilable, all_sources)), "LOCAL_SRC_FILES"
        )
...
def GenerateOutput(target_list, target_dicts, data, params):
    ...
    for qualified_target in target_list:
        ...
        assert (
            make_global_settings_array == this_make_global_settings
